...
# hexagonal tiles, starting at "12 o'clock" and numbering the
# tiles 2 to 7 in an anti-clockwise direction.

# New rings are added in the same fashion, with the next rings
# being numbered 8 to 19, 20 to 37, 38 to 61, and so on. The
# diagram below shows the first three rings.
...
# 16, 1, 11, and 10, hence PD(17) = 2.

# It can be shown that the maximum value of PD(n) is 3.

# If all of the tiles for which PD(n) = 3 are listed in
# ascending order to form a sequence, the 10th tile would
# be 271.
